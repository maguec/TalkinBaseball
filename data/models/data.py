...
class PitchAbbrs:
    ...
    def __init__(self):
        self.pitches = []
        pitch_abbrs = [
            {"abbr": "CH", "pitch": "Changeup"},
            {"abbr": "CS", "pitch": "SlowCurve"},
            {"abbr": "CU", "pitch": "Curveball"},
            {"abbr": "EP", "pitch": "Eephus"},
            {"abbr": "FA", "pitch": "Fastball"},
            {"abbr": "FC", "pitch": "Cutter"},
            {"abbr": "FF", "pitch": "4-Seam"},
            {"abbr": "FO", "pitch": "Forkball"},
            {"abbr": "FS", "pitch": "Splitter"},
            {"abbr": "KC", "pitch": "KnuckleCurve"},
            {"abbr": "KN", "pitch": "Knuckleball"},
            {"abbr": "PO", "pitch": "Pitchout"},
            {"abbr": "SC", "pitch": "Screwball"},
            {"abbr": "SI", "pitch": "Sinker"},
            {"abbr": "SL", "pitch": "Slider"},
            {"abbr": "ST", "pitch": "Sweeper"},
